...
if (isset($_SESSION['usuario'])) {
    ...
    if (isset($_POST['like']) || isset($_POST['unlike']) || isset($_POST['comentario']) || isset($_POST['borrar'])) {
        ...
        if (isset($_POST['borrar'])) {
            ...
            $row1 = mysqli_query($con, "INSERT INTO `comentario` (`id_comentario`, `id_usuario`, `id_contenido`, `texto`) VALUES (NULL, '" . $row['id_usuario'] . "', '" . $_POST['comentario'] . "', '" . $_POST['textoCommentario'] . "');");
                    ...
                    <article>
                        ...
                        while ($contenido = mysqli_fetch_array($rowContenido)) {
                            ...
                            <div class="botones">
                                ...
                                <input  type="text" name="textoCommentario" class=comentarioPersonal" placeholder="Introduzca comentario..." style="width: 70%"/>
                            </div>
                            <?PHP
